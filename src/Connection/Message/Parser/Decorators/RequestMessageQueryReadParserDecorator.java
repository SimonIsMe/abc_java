...
public class RequestMessageQueryReadParserDecorator extends AbstractRequestMessageQueryParserDecorator
{
    ...
    public RequestMessageQueryReadParserDecorator(RequestMessageQueryParser requestMessageParser)
    {
